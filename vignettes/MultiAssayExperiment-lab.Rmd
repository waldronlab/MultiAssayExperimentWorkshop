...
There is a built version of this workshop available at http://rpubs.com/lwaldron/MAEWorkshop. The source is available at https://github.com/waldronlab/MultiAssayExperimentWorkshop.
...
```
Note, the first line installs experimental data packages not installed automatically by biocLite.
